        ...
        <div className="flex flex-row py-[7.5rem] flex-wrap gap-y-20">
          ...
          <div className="px-10">
            ...
            <p className="py-5 max-w-xl text-justify text-2xl text-muted-foreground">
              ...
              рахунки з різними відсотковими ставками та строками, що дозволило
              б клієнтам заощаджувати гроші та заробляти відсотки з плином часу.
              Ці рахунки можуть включати такі функції, як автоматичні перекази,
              захист від овердрафту та доступ до мобільного банкінгу.
            </p>
          </div>
          ...
          <div className="px-10">
            ...
            <p className="py-5 max-w-xl text-justify text-2xl text-muted-foreground">
              Financial Universal Bank може запропонувати кредити на різні цілі,
              такі як консолідація боргу, покращення житла або великі покупки.
              Клієнти можуть подати заявку онлайн і швидко отримати рішення, з
              гнучкими умовами погашення та конкурентоспроможними відсотковими
              ставками.
            </p>
          </div>
          ...
          <div className="px-10">
            ...
            <p className="pt-5 max-w-xl text-justify text-2xl text-muted-foreground">
              Financial Universal Bank може запропонувати зручний сервіс оплати
              рахунків онлайн, що дозволить клієнтам сплачувати рахунки та
              керувати витратами зі свого комп'ютера або мобільного пристрою. Ця
              послуга може включати такі функції, як автоматичні платежі,
              нагадування про рахунки та настроювані графіки платежів.
            </p>
          </div>
      ...
      <div className="bg-light flex flex-row">
        <div className="px-[7.5rem] py-[7.5rem]">
          ...
          <p className="pt-24 max-w-screen-md text-justify text-2xl text-muted-foreground">
            Ви можете відкрити рахунок в FUBank онлайн, відвідавши наш веб-сайт
            і заповнивши форму онлайн-заявки. Після того, як ваша заявка буде
            схвалена, ви отримаєте інструкції з налаштування вашого рахунку та
            доступу до нашої платформи онлайн-банкінгу.
          </p>
        </div>
